...
class ChatAdapter(val listener: (ChatItem) -> Unit) :
    ...
    abstract inner class TouchableChatItemViewHolder(override val containerView: View) :
        ...
        override fun onItemSelected() {
            ...
            itemView.context.theme.resolveAttribute(
                    R.attr.colorItemSelectedBackground,
                    colorBackground,
                    true
            )
    ...
    inner class SingleViewHolder(override val containerView: View) :
            TouchableChatItemViewHolder(containerView) {
    ...
    inner class ArhiveViewHolder(override val containerView: View) :
